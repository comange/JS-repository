...
// я міг би це зробити, звичайно, але ми цього не проходили тому я відчуваю що це завдання на майбутнє.
...
for (let i = 1; i < 11; i += 1) {
    if (i !== 7) {console.log(i)} else {break}
}
